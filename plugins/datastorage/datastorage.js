...
module.exports = function setup (options, imports, register) {
  ...
  DataStorage.prototype.isDataFileExisted = function (fpath, fname, cb) {
    var _joined_name = reportDatabaseUtils.joinDataFileName(fpath, fname);
  ...
  DataStorage.prototype.saveFileAsDataFile = function (srcFile, dataFilePath, dataFileName, cb) {
    var _joined_name = reportDatabaseUtils.joinDataFileName(dataFilePath, dataFileName);
  ...
  DataStorage.prototype.setTemplatePath = function (rptPaht, rptName, tPath, cb) {
    this.reportDB.setTemplatePath(rptPaht, rptName, tPath, cb);
  };
